 ...
 */
@Composable
fun HandrailTheme(content: @Composable () -> Unit) {
    val colorScheme = lightColorScheme(
        primary = HandrailColors.Accent700,
        onPrimary = HandrailColors.Accent100,
        secondary = HandrailColors.Accent,
        background = HandrailColors.Bg,
        onBackground = HandrailColors.Text,
        surface = HandrailColors.Bg,
        onSurface = HandrailColors.Text,
        surfaceVariant = HandrailColors.Surface,
        onSurfaceVariant = HandrailColors.Neutral700,
        outline = HandrailColors.Divider,
        error = HandrailColors.Accent800,
    )
    ...
    val typography = Typography(
        ...
        headlineLarge = bodyStyle.copy(fontFamily = HandrailType.Cormorant, fontSize = 36.sp, lineHeight = 41.sp),
        headlineMedium = bodyStyle.copy(fontFamily = HandrailType.Cormorant, fontSize = 30.sp, lineHeight = 38.sp),
        headlineSmall = bodyStyle.copy(fontFamily = HandrailType.Cormorant, fontSize = 23.sp, lineHeight = 27.sp),
        titleLarge = bodyStyle.copy(fontFamily = HandrailType.Cormorant, fontWeight = FontWeight.W500, fontSize = 20.sp),
        labelLarge = bodyStyle.copy(fontFamily = HandrailType.Cormorant, fontSize = 19.sp, letterSpacing = 1.5.sp),
    )

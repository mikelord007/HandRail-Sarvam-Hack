...
/**
 * Spacing / radius / elevation tokens from the Classical design system.
 * Density 1.15× scale, ported as-drawn (px in the HTML prototype == dp here).
 */
object HandrailDimens {
    // Spacing scale
